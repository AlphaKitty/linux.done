...
<p align="center">
  <img src="icons/icon128.png" width="96" height="96" alt="linux.done logo">
</p>

<p align="center">
  <strong>LINUX DO 社区订阅式帖子监控 Chrome 扩展</strong><br>
  <em>Subscription-based post monitoring for <a href="https://linux.do">LINUX DO</a></em>
</p>

<p align="center">
  <a href="https://chromewebstore.google.com/detail/linuxdone/YOUR_EXTENSION_ID"><img src="https://img.shields.io/badge/Chrome_Web_Store-Install-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Chrome Web Store"></a>
  &nbsp;
...
> 将下方链接中的 `YOUR_EXTENSION_ID` 替换为你在 Chrome Web Store 的真实扩展 ID。

**[在 Chrome 网上应用店安装 linux.done](https://chromewebstore.google.com/detail/linuxdone/YOUR_EXTENSION_ID)**
...
1. 克隆本仓库并进入扩展目录：
   ...
   ```bash
   git clone https://github.com/<your-username>/linux.done.git
   cd linux.done
   ```
...
<details>
<summary><strong>为什么开着论坛时通知更快？</strong></summary>
...
<details>
<summary><strong>设置了规则却没有通知？</strong></summary>
...
<details>
<summary><strong>会对 LINUX DO 或本机造成负担吗？</strong></summary>
...
<details>
<summary><strong>是否需要登录 LINUX DO？</strong></summary>
...
<p align="center">
  <img src="icons/wechat-pay.png" width="280" alt="微信赞赏码 · NullPointer">
  &nbsp;&nbsp;
  <img src="icons/赞赏码1.png" width="280" alt="赞赏码 · NullPointer">
</p>

<p align="center">
  <sub>微信扫码赞赏 · NullPointer</sub>
</p>
...
- **Chrome Web Store (recommended):**  
  [Install linux.done](https://chromewebstore.google.com/detail/linuxdone/YOUR_EXTENSION_ID)  
  *(Replace `YOUR_EXTENSION_ID` with the real store ID.)*
...
<p align="center">
  <sub>Made with ☕ for the LINUX DO community · Not affiliated with linux.do</sub>
</p>
